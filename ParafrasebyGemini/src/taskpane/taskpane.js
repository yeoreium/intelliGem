...
const BACKEND_URL = "https://intelli-gem-dcyq.vercel.app/api/intelligem";
...
function addMessageToChat(sender, explanation, perluActionable = null, originalContextText = null, actionableText = null) {
    ...
    if (sender === 'ai') {
        ...
        if (actionableText) {
            ...
            const actionable_text_html = `<div class="actionable-text-html">${marked.parse(actionableText)}</div>`
            console.log(actionable_text_html);
